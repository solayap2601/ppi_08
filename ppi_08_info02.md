...
[Couch Surfing](https://about.couchsurfing.com/about/how-it-works/)
...
[Tulio Recomienda](https://tuliorecomienda.com/)
...
[Flask](https://flask.palletsprojects.com/en/2.2.x/) o [Django](https://www.djangoproject.com/): Son frameworks de Python para desarrollo web. Ambos son de código abierto y tienen una gran comunidad de usuarios que proporcionan recursos y herramientas útiles para el desarrollo web.

[PostgreSQL](https://www.postgresql.org/) o [MySQL](https://www.mysql.com/): Son sistemas de gestión de bases de datos de código abierto que pueden ser utilizados para almacenar los datos de la aplicación. Ambos sistemas son muy populares y están ampliamente documentados.
